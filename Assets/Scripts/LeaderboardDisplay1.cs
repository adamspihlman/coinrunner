...
public class LeaderboardDisplay1 : MonoBehaviour
{
    /// <summary>
    ...
    private void RefreshLBDisplay()
    {
        ...
        switch (displayChoice)
        {
            case DisplayOptions.Unordered:
                _data = LeaderboardManager.LoadLeaderboardData(1);
                break;
            case DisplayOptions.Descending:
                _data = LeaderboardManager.LoadLeaderboardDataDescending(1);
                break;
            case DisplayOptions.Ascending:
                _data = LeaderboardManager.LoadLeaderboardDataAscending(1);
                break;
            default:
                break;
        }
