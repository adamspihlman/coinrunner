...
public class LeaderboardDisplay2 : MonoBehaviour
{
    /// <summary>
    ...
    private void RefreshLBDisplay()
    {
        ...
        switch (displayChoice)
        {
            case DisplayOptions.Unordered:
                _data = LeaderboardManager.LoadLeaderboardData(2);
                break;
            case DisplayOptions.Descending:
                _data = LeaderboardManager.LoadLeaderboardDataDescending(2);
                break;
            case DisplayOptions.Ascending:
                _data = LeaderboardManager.LoadLeaderboardDataAscending(2);
                break;
            default:
                break;
        }
